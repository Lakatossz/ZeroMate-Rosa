...
class Test_Ads1115_Pbmh : public ::testing::Test {
private:
    static inline Test_Ads1115_Pbmh* current_instance{ nullptr };
...
// Testovací pøípady
//-----------------------------------------------------------------------------
TEST_F(Test_Ads1115_Pbmh, Basic_Initialization) {
    bool correct = true;
...
TEST_F(Test_Ads1115_Pbmh, Read_Pressure_Once) {
    bool correct = true;
...
TEST_F(Test_Ads1115_Pbmh, Read_Pressure_Many_Times) {
    bool correct = true;
...
TEST_F(Test_Ads1115_Pbmh, Read_Higher_Pressure_Once) {
    bool correct = true;
...
TEST_F(Test_Ads1115_Pbmh, Read_Lower_Pressure_Once) {
    bool correct = true;
