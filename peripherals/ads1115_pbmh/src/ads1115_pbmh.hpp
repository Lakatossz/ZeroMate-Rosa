...
// ---------------------------------------------------------------------------------------------------------------------
/// \class CAds1115_Pbmh
/// \brief This class represents an CAds1115_Pbmh pressure sensor.
// ---------------------------------------------------------------------------------------------------------------------
class ZM_EXTERNAL_PERIPHERAL_API CAds1115_Pbmh final : public zero_mate::IExternal_Peripheral
{
public:
	...
	// -----------------------------------------------------------------------------------------------------------------
	explicit CAds1115_Pbmh(const std::string name,
...
private:
	...
	const char* const Ads1115_Pbmh_Config_File = "peripherals/ads1115_pbmh_config.json";
	...
	// -----------------------------------------------------------------------------------------------------------------
	inline void Render_Pressure_Sensor();
	...
	// -----------------------------------------------------------------------------------------------------------------
	/// \brief Returns current pressure value.
	// -----------------------------------------------------------------------------------------------------------------
	...
	float m_referenced_value;
	float m_higher_value;
	float m_lower_value;
	bool m_higher_pressure;
	bool m_lower_pressure;
